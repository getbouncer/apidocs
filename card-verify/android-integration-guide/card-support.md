...
Some cards have very specific ways of arranging the numbers when they are displayed. The CardVerify SDK has an option
that allows for the formatting of custom pans. Just use the following method:
