...
```text
dependencies {
    implementation 'com.getbouncer:cardscan-ui:2.0.0076'
    ...
    implementation 'com.getbouncer:tensorflow-lite:2.0.0076'

    // If you only plan to support ARM devices, use this library
    implementation 'com.getbouncer:tensorflow-lite-arm-only:2.0.0076'
}
```
