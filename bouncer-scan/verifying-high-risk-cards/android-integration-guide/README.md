...
| :--- | :--- | :--- | :--- |
| App does not yet use TFLite & app _is not_ published as bundle | 3.9MB | 4.0MB | 7.9MB |
| App does not yet use TFLite & app _is_ published as a bundle | 3.9MB | 1.0MB | 4.9MB |
| App already uses TFLite | 3.9MB | 0.0MB | 3.9MB |
...
```text
dependencies {
    implementation "com.getbouncer:scan-framework:2.0.0068"
    implementation "com.getbouncer:scan-camera:2.0.0068"
    implementation "com.getbouncer:scan-ui:2.0.0068"
    implementation "com.getbouncer:scan-payment:2.0.0068"
