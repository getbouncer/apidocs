...
| Bouncer TF all architectures | 2.12MB | 0.62MB | `com.getbouncer:tensorflow-lite:2.0.0078` |
| Bouncer TF arm only | 1.06MB | 0.62MB | `com.getbouncer:tensorflow-lite-arm-only:2.0.0078` |
...
| :--- | :--- | :--- | :--- | :--- |
| OCR | full size | 1.6 MB | 1.5 MB | `com.getbouncer:scan-payment-ocr:2.0.0078` |
| Card Detection | full size | 1.3 MB | 1.2 MB | `com.getbouncer:scan-payment-card-detect:2.0.0078` |
| OCR | minimal | 1.1 MB | 0.9 MB | `com.getbouncer:scan-payment-ocr-minimal:2.0.0078` |
| Card Detection | minimal | 0.5 MB | 0.3 MB | `com.getbouncer:scan-payment-card-detect-minimal:2.0.0078` |
...
```text
dependencies {
    implementation "com.getbouncer:scan-framework:2.0.0078"
    implementation "com.getbouncer:scan-camera:2.0.0078"
    implementation "com.getbouncer:scan-ui:2.0.0078"
    implementation "com.getbouncer:scan-payment-base:2.0.0078"
    implementation 'com.getbouncer:cardverify-ui:2.0.0078'
    ...
    implementation "com.getbouncer:scan-payment-ocr-minimal:2.0.0078"
    implementation "com.getbouncer:scan-payment-card-detect-minimal:2.0.0078"
    ...
    // dependencies.
    implementation "com.getbouncer:scan-payment-ocr:2.0.0078"
    implementation "com.getbouncer:scan-payment-card-detect:2.0.0078"
    ...
    implementation 'com.getbouncer:tensorflow-lite:2.0.0078'

    // If you only plan to support ARM devices, use this library
    implementation 'com.getbouncer:tensorflow-lite-arm-only:2.0.0078'
}
```
