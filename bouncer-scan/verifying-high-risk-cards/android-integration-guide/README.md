...
| Bouncer TF all architectures | 3.3MB | 0.8MB | `com.getbouncer:tensorflow-lite:2.0.0075` |
| Bouncer TF arm only | 1.9MB | 0.8MB | `com.getbouncer:tensorflow-lite-arm-only:2.0.0075` |
...
```text
dependencies {
    implementation "com.getbouncer:scan-framework:2.0.0075"
    implementation "com.getbouncer:scan-camera:2.0.0075"
    implementation "com.getbouncer:scan-ui:2.0.0075"
    implementation "com.getbouncer:scan-payment:2.0.0075"
    implementation "com.getbouncer:scan-payment-card-detect:2.0.0075"
    implementation 'com.getbouncer:cardverify-ui:2.0.0075'
    ...
    implementation 'com.getbouncer:tensorflow-lite:2.0.0075'

    // If you only plan to support ARM devices, use this library
    implementation 'com.getbouncer:tensorflow-lite-arm-only:2.0.0075'
}
```
