...
### Images
Images must be added to the native iOS project’s `Image.xcasset`  folder and the must be named <em>**exactly**</em> as listed above. 

| Image Names              | Description                         |
| ------------------------ | ----------------------------------- |
| bouncer_verify_flash_on  | Image of button to turn on flash    |
| bouncer_verify_flash_off | Image of button to turn off flash   |
| bouncer_verify_back      | Image of button to go back  |
