...
```text
dependencies {
    implementation 'com.getbouncer:liveness-ui:2.0.0049'
}
```
...
Before you can use Liveness, you must have an API key set up through the [Bouncer API console](https://api.getbouncer.com/console). Please contact [support@getbouncer.com](mailto:support@getbouncer.com) to ensure the correct permissions have been added to your API key.
...
See the [development docs](../../card-scan/android-integration-guide/development-guide.md) for details on developing for Liveness.
...
All contributors must agree to the [Contributor License Agreement](https://github.com/getbouncer/cardscan-android/blob/master/Contributor%20License%20Agreement).
