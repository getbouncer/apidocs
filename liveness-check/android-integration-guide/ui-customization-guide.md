...
Liveness uses standard android XML configuration files to define strings displayed in the UI. This allows clients to override the default text values and localize the text.
...
The Liveness SDK uses the following text fields:
...
Liveness fully supports left-to-right languages.

## Colors

Liveness uses standard android XML configuration files to define colors displayed in the UI. This allows clients to override the default colors to better match the theme of their app.
...
The Liveness SDK uses the following color definitions:
...
Liveness uses standard android XML configuration files to define dimensions used to lay out the UI, including padding, text size, line widths, and more. This allows clients to override the default dimensions to better match the theme of their app.
...
The Liveness SDK uses the following dimension definitions:
...
Liveness uses standard android icon files and formats. This allows clients to override the default icons to better match the theme of their app.
...
Liveness uses the following drawables:
